...
int main(int argc, char *argv[])
{
    ...
    unsigned int cubemapTetxure = loadCubeTexture(faces);
    ...
    Shader skyboxShader("./shader/skybox_vertex.glsl", "./shader/skybox_fragment.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(GL_TEXTURE_CUBE_MAP, cubemapTetxure);
