...
*/
    ...
    Shader shaderSingleColor("./shader/object_vertex.glsl", "./shader/shaderSingleColor.glsl");
    shader.setInt("diffuseTexture", 0);
    Shader shaderFrameBuffer("./shader/frameBuffer_vertex.glsl", "./shader/frameBuffer_fragment.glsl");
    ...
    if (glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE)
        cout << "ERROR::FRAMBEBUFFER::FrameBuffer is not complete!" << endl;
