...
*/
    ...
    unsigned int containerTexture = loadTexture("./static/texture/container.jpg");

    Shader shader("./shader/object_vertex.glsl", "./shader/object_fragment.glsl");
    Shader shaderBlur("./shader/blur_vertex.glsl", "./shader/blur_fragment.glsl");
    Shader shaderLight("./shader/light_vertex.glsl", "./shader/light_fragment.glsl");
    Shader shaderFrameBuffer("./shader/frameBuffer_vertex.glsl", "./shader/frameBuffer_fragment.glsl");

    shader.use();
    shader.setInt("diffuseTexture", 0);
    shaderFrameBuffer.use();
    shaderFrameBuffer.setInt("scene", 0);
    shaderFrameBuffer.setInt("bloomBlur", 1);
